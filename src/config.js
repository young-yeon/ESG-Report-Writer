...
6. 본문과 핵심 근거 설명이 정보량의 중심이어야 하며, 하단 도식/표는 자료 기반 메시지를 보조한다.
7. 보도자료형 원문은 홍보 문구를 반복하지 말고 "누가/언제/무엇을/어떤 규모로/왜 중요한지/향후 계획"을 보고서 문체로 재구성한다.
8. 자료에 없는 성과 수치, 감축량, 투자액, 일정은 만들지 말고 "추가 확인 필요"라고 표기한다.
9. 색상은 data-accent만 정확히 지정한다. Business=business, Environmental=environmental, Social=social, Governance=governance.
